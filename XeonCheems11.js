...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    ...
    return await XeonBotInc.relayMessage(chatId, generate.message, { messageId: generate.key.id })
        ...
        let fstatus = { 
            ...
            //Fake quoted 
        const fpay = { key: { remoteJid: '0@s.whatsapp.net', fromMe: false, id:global.botname, participant: '0@s.whatsapp.net'}, message: { requestPaymentMessage: { currencyCodeIso4217: "USD", amount1000: 999999999, requestFrom: '0@s.whatsapp.net', noteMessage: { extendedTextMessage: { text: global.botname}}, expiryTimestamp: 999999999, amount: { value: 
929291929, offset: 1000, currencyCode: "USD"}}}}
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/3vWk6xY/cheemspic.jpg',
                                sourceUrl: wagc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
